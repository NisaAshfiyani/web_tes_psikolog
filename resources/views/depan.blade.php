      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            @endif
            @if ($youtube)
            <a class="btn btn-outline-light btn-social mx-1" href="{{$youtube}}" target="blank"><i class="fab fa-fw fa-instagram"></i></a>
            @endif
            @if ($youtube)
            <a class="btn btn-outline-light btn-social mx-1" href="{{$youtube}}" target="blank"><i class="fab fa-fw fa-twitter"></i></a>
            @endif
            @if ($youtube)
            <a class="btn btn-outline-light btn-social mx-1" href="{{$youtube}}" target="blank"><i class="fab fa-fw fa-facebook-f"></i></a>
            @endif
        </div>
          <!-- Footer About Text-->
          <div class="col-lg-4">
